...
# use_container_width=True 가로로 화면에 채워 줌
st.altair_chart(chart, use_container_width=True)   

# 4-2. Altair Bar chart
...
fig = px.pie(medal, names = "nation", values = "gold", title="올림픽 양궁 금메달 현황"
, hole=.3 )
